...
void error(std::vector<std::vector<double>> U_rho, std::vector<std::vector<double>> U_rhou, std::vector<std::vector<double>> U_rhov, std::vector<std::vector<double>> U_E, std::vector<std::vector<double>> U_rho_exact, std::vector<std::vector<double>> U_rhou_exact, std::vector<std::vector<double>> U_rhov_exact, std::vector<std::vector<double>> U_E_exact, std::string result, int n, double dx, double dy, double gamma, double b, int fichier);
